      ...
      <div className='w-[94vw] h-screen sticky top-0'>
        ...
        >
          <div ref={wrape} className='wrapper snap-center shrink-0 w-[94vw] h-full py-4 gap-4 flex items-center justify-around '>
              <P3card x={'translate-x-[80%]'} src={'https://raw.githubusercontent.com/ShivamS28/FellowshipFrontiers-ReimagineRound2/main/public/Magazine%20cover%201.webp'} z={'z-10'} />
            <P3card x={'translate-x-0'} src={'https://raw.githubusercontent.com/ShivamS28/FellowshipFrontiers-ReimagineRound2/main/public/Magazine%20cover%202.webp'} z={'z-20'} />
            <P3card x={'-translate-x-[80%]'} src={'https://raw.githubusercontent.com/ShivamS28/FellowshipFrontiers-ReimagineRound2/main/public/Magazine%20cover%203.webp'} z={'z-10'} />
          </div>
          <div className='wrapper snap-center shrink-0 w-[94vw] h-full gap-4 flex items-center justify-around '>
            <P3card x={'translate-x-[80%]'} src={'https://raw.githubusercontent.com/ShivamS28/FellowshipFrontiers-ReimagineRound2/main/public/Magazine%20Cover%204.webp'} z={'z-10'} />
            <P3card x={'translate-x-0'} src={'https://raw.githubusercontent.com/ShivamS28/FellowshipFrontiers-ReimagineRound2/main/public/Magazine%20cover%205.webp'} z={'z-20'} />
            <P3card x={'-translate-x-[80%]'} src={'https://raw.githubusercontent.com/ShivamS28/FellowshipFrontiers-ReimagineRound2/main/public/Magazine%20Cover%206.webp'} z={'z-10'} />
          </div>
